...
public class MapTest extends AppCompatActivity implements AbsListView.OnScrollListener,OnMapReadyCallback {
    ListView listView;
    GoogleMap googleMap;
...
//You can use customAdapter also…
        listView.setAdapter(new ArrayAdapter<>(MapTest.this, android.R.layout.simple_list_item_1,arrayList));
