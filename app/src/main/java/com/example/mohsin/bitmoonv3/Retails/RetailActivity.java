package com.example.mohsin.bitmoonv3.Retails;
...
public class RetailActivity extends Activity{
    ...
    public void getData()
    {
        String food_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/3/1/vendors?lang=";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, food_urlA,
                        ...
                        try {
                            ...
                            if(response1.equals("[]"))
                            {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    adapter = new FoodAdapter2(RetailActivity.this, list);
                                ...
                                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                        ...
                                        bundle.putString("Activity", "Retail");
                                        i.putExtras(bundle);
                                        startActivity(i);
                                        overridePendingTransition(R.anim.slide_right, R.anim.slide_left);
                                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RetailActivity.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        ...
        MySingleton.getmInstance(RetailActivity.this).addToRequestque(stringRequest);
    }

    public void get_type()
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_types/3?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            list_type.clear();
                            type_adapter=new TypeAdapter(RetailActivity.this,list_type);
    ...
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_additional_details/3?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                filterAdapter=new FilterAdapter(RetailActivity.this,FilterList);
    ...
    public void preferences()
    {
        ...
        if(LanGet.equals("en"))
        {
            ...
            FoodTxt.setText("Retail & Services");
            Map.setText("MAP");
        }
        else if(LanGet.equals("ar"))
        {
            relativeLayout.setLayoutDirection(RTL);
            FoodTxt.setText("خدمات التجزئة");
            Map.setText("خرائط");
        }
    }
