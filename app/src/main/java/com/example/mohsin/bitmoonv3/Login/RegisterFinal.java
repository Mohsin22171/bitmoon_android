...
public class RegisterFinal extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    List<String> country_list2 = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url= Base_Url+"/bitmoonbackend/public/index.php/api/user/signup";
        country_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/countries?lang=en";
        city_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/cities?lang=en&country=";
        ...
        builder = new AlertDialog.Builder(RegisterFinal.this);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        {
            country_id=country_list2.get(i);
            Log.d("Response123",country_id);
    ...
    public void getData2()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, country_url,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                ...
                                String country_id=actor.getString("country_id");
                                Log.i("Response",name);
                                country_list.add(name);
                                country_list2.add(country_id);
                            }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RegisterFinal.this, "No Internet Connection", Toast.LENGTH_LONG).show();
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Content-type","application/json");
                headers.put("Authorization", "5a5c9f0305cba");
                headers.put("client-id", "bitmoon-app-android");
                return headers;
            }
        };
        MySingleton.getmInstance(RegisterFinal.this).addToRequestque(stringRequest);
    }
    ...
    public void getData3()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, city_url2,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            city_adapter = new ArrayAdapter<String>(RegisterFinal.this, simple_spinner_item, city_list);
