package com.example.mohsin.bitmoonv3.Hotels;
...
public class HotelActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                String a=list.get(position).getName();
    ...
    public void getData()
    {
        String food_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/4/1/vendors?lang=";
                        ...
                        try {
                            ...
                            if(response1.equals("[]"))
                            {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    adapter = new FoodAdapter2(HotelActivity.this, list);
                                ...
                                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                        ...
                                        bundle.putString("Activity", "Hotel");
                                        i.putExtras(bundle);
                                        startActivity(i);
                                        overridePendingTransition(R.anim.slide_right, R.anim.slide_left);
                                    }
        ...
        MySingleton.getmInstance(HotelActivity.this).addToRequestque(stringRequest);
    }

    public void get_type()
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_types/4?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            list_type.clear();
                            type_adapter=new TypeAdapter(HotelActivity.this,list_type);
    ...
    {
        String type_url="http://54.187.13.62/bitmoonbackend/public/index.php/api/user/vendor_cuisine/4?lang=en";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            list_cuisine.clear();
                            cuisineAdapter=new CuisineAdapter(HotelActivity.this,list_cuisine);
    ...
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_additional_details/4?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                filterAdapter=new FilterAdapter(HotelActivity.this,FilterList);
    ...
    public void preferences()
    {
        ...
        if(LanGet.equals("en"))
        {
            ...
            FoodTxt.setText("Hotels & Worldwide");
            Map.setText("MAP");
        }
        else if(LanGet.equals("ar"))
        {
            relativeLayout.setLayoutDirection(RTL);
            FoodTxt.setText("الفنادق والعالم");
            Map.setText("خرائط");
        }
    }
