package com.example.mohsin.bitmoonv3.BeautyFitness;
...
import com.example.mohsin.bitmoonv3.FoodDrink.FoodMaps;
...
public class BeautyActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(), FoodMaps.class);
        ...
        Filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Button done=(Button)dialog.findViewById(R.id.done_filter);
                    ...
                    public void onClick(View view) {
                        try {
                            TypeArray=new JSONArray(Type);
                            CuisineArray=new JSONArray(CuisineItem.toString());
                            AddItem=new JSONArray(Item1.toString());
                            Log.d("TypeArray",TypeArray.toString());
                            Log.d("TypeArray2",CuisineArray.toString());
                            Log.d("TypeArray3",AddItem.toString());
                            get_Filter_Data();
    ...
    public void getData()
    {
        String food_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/5/1/vendors?lang=";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, food_urlA,
                        ...
                        try {
                            ...
                            if(response1.equals("[]"))
                            {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    adapter = new FoodAdapter2(BeautyActivity.this, list);
                                ...
                                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                        ...
                                        Bundle bundle = new Bundle();
                                        bundle.putString("Activity", "Beauty");
                                        i.putExtras(bundle);
                                        startActivity(i);
                                        overridePendingTransition(R.anim.slide_right, R.anim.slide_left);
                                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BeautyActivity.this, "No Internet Connection", Toast.LENGTH_LONG).show();
        ...
        MySingleton.getmInstance(BeautyActivity.this).addToRequestque(stringRequest);
    }

    public void get_type()
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_types/5?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            list_type.clear();
                            type_adapter=new TypeAdapter(BeautyActivity.this,list_type);
    ...
    {
        String type_url=Base_Url+"/bitmoonbackend/public/index.php/api/user/vendor_additional_details/5?lang="+LanGet;
        StringRequest stringRequest = new StringRequest(Request.Method.GET, type_url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                filterAdapter=new FilterAdapter(BeautyActivity.this,FilterList);
    ...
    public void get_Filter_Data(){
        String url2="http://www.appstudeo.com/bitmoonbackend/public/index.php/api/user/5/vendors?lang="+LanGet+"&page=1&limit=10";
        try {
    ...
    public void preferences()
    {
        ...
        if(LanGet.equals("en"))
        {
            ...
            FoodTxt.setText("Beauty & Fitness");
            Map.setText("MAP");
        }
        else if(LanGet.equals("ar"))
        {
            relativeLayout.setLayoutDirection(RTL);
            FoodTxt.setText("الجمال واللياقة البدنية");
            Map.setText("خرائط");
        }
    }
